@REM forms launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM FORMS_config.txt found in the FORMS_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%FORMS_HOME%"=="" set "FORMS_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%FORMS_HOME%\lib\"
...
set "CFG_FILE=%FORMS_HOME%\FORMS_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running forms.
  echo.
